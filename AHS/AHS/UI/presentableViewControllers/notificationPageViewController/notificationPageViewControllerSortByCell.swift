//
//  notificationPageViewControllerSortByCell.swift
//  AHS
//
//  Created by Richard Wei on 7/28/21.
//

import Foundation
import UIKit

class notificationPageSortByCell : UITableViewCell{
    static let identifier : String = "notificationPageSortByCell";
    ...
    public func renderMethod(_ index: Int, _ height: CGFloat){ // 0 based
        ...
        titleLabel.text = notificationSortingStruct.notificationSortingMethods.nameFromIndex(index);
