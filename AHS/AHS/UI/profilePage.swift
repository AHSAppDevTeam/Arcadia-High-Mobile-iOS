...
class profilePageViewController : mainPageViewController{
    ...
    func CreateItemsInScrollView() {
     ...
     // textView.backgroundColor = UIColor.white
        ...
        //Ancors the About US Button to the top of the App Version Button
        scrollView.addSubview(AboutUS)
        AboutUS.translatesAutoresizingMaskIntoConstraints = false
        AboutUS.heightAnchor.constraint(equalToConstant: 45).isActive = true
        AboutUS.widthAnchor.constraint(equalToConstant: 380).isActive = true
        AboutUS.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor).isActive = true
        AboutUS.topAnchor.constraint(equalTo: infoTextLabel.bottomAnchor).isActive = true
        
        
        //Ancors the App Version Button to the top of the Terms and Agreements Button
        scrollView.addSubview(AppVersion)
        AppVersion.translatesAutoresizingMaskIntoConstraints = false
        AppVersion.heightAnchor.constraint(equalToConstant: 45).isActive = true
        AppVersion.widthAnchor.constraint(equalToConstant: 380).isActive = true
        AppVersion.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor).isActive = true
        AppVersion.topAnchor.constraint(equalTo: AboutUS.bottomAnchor).isActive = true
        
        
        //Ancors the Terms and Agreements button to the bottom of the page
        scrollView.addSubview(TermsandAgreements)
        TermsandAgreements.translatesAutoresizingMaskIntoConstraints = false
        TermsandAgreements.heightAnchor.constraint(equalToConstant: 45).isActive = true
        TermsandAgreements.widthAnchor.constraint(equalToConstant: 380).isActive = true
        TermsandAgreements.centerXAnchor.constraint(equalTo: scrollView.centerXAnchor).isActive = true
