...
class profilePageViewController : mainPageViewController{
 ...
 //   let navigation = UINavigationController(rootViewController: profilePageViewController())
    ...
    override func viewDidLoad() {
        ...
        super.viewDidLoad();
//        let myNavigationController = UINavigationController(rootViewController: SchedulePageViewController())
...
//        appDelegate.window?.rootViewController = myNavigationController
    ...
    @objc private func didTapSchedule(){
       ...
       self.navigationController?.pushViewController(SchedulePageViewController(), animated: true)
